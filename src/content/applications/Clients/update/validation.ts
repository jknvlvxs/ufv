...
export default class Validation {
  static schema = yup.object().shape({
    ...
    documentFile: yup.mixed().optional(),
    receiptAddress: yup.mixed().optional(),
    receiptIncome: yup.mixed().optional(),
    ...
    fatherName_physicalPerson_locatario: yup
      .string()
      .when('personValue', { is: 'physical', then: yup.string().nullable() }),
    ...
    nameOfPayRent_physicalPerson_locatario: yup.string().when('personValue', {
      ...
      then: yup
        .string()
        .nullable()
        .when('payRent_physicalPerson_locatario', {
          is: 'yes',
          then: yup.string().required('Campo obrigatório!'),
        }),
    }),
    ...
    spouseName_physicalPerson: yup.string().when('personValue', {
      ...
      then: yup
        .string()
        .nullable()
        .when('civilStatus_physicalPerson_locatario', {
          is: 'casado(a)',
          then: yup.string().required('Campo obrigatório!'),
        }),
    }),
    ...
    othersIncome: yup.string().nullable(),

    referenceBankName: yup.string().nullable(),
    referenceBankAgency: yup.string().nullable(),
    referenceBankAccount: yup.string().nullable(),
    referenceBankCity: yup.string().nullable(),

    referenceBankYearOpenAccount: yup.date().nullable(),

    referenceBankName_2: yup.string().nullable(),
    referenceBankAgency_2: yup.string().nullable(),
    referenceBankAccount_2: yup.string().nullable(),
    referenceBankCity_2: yup.string().nullable(),
    ...
    guarantorFatherName: yup
      .string()
      .when('guarantorValue', { is: 'yes', then: yup.string().nullable() }),
