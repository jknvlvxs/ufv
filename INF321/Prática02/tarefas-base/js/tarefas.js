...
function acaoConcluir() {
    ...
    let spanTarefa= li.firstElementChild; // O primeiro filho do tipo Element é o span
...
function acaoEditar() {
    if (buffer == null) {
        ...
        // Passo 2, acima
        let spanTarefa= li.firstElementChild;
...
function acaoAtualizar() {
    ...
    if (texto != '') {
        // Passo 2, acima
        let spanTarefa= buffer.firstElementChild;
