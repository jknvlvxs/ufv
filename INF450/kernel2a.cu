...
__global__ void kmeansReduce(float *input, float *centroids, int *counter, const int n, float *v_r) {
    ...
    for (int j = 0; j < WORK; j++) {
        if (i < n) {
            ...
            k1_d1 = k1_d1 + k1_d2 + k1_d3;
            k2_d1 = k2_d1 + k2_d2 + k2_d3;
            ...
            k0_d1 = point_d1 - centroids[27]; // primeiro centroide
    ...
    __shared__ float partial_sum[BLOCO * 32];
    ...
    partial_sum[threadIdx.x] = cont5_1;
    partial_sum[threadIdx.x + blockDim.x] = cont5_2;
    partial_sum[threadIdx.x + 2 * blockDim.x] = cont5_3;
    partial_sum[threadIdx.x + 3 * blockDim.x] = cont5_4;
    partial_sum[threadIdx.x + 4 * blockDim.x] = nc6_0x;
    partial_sum[threadIdx.x + 5 * blockDim.x] = nc6_0y;
    partial_sum[threadIdx.x + 6 * blockDim.x] = nc6_0z;
    partial_sum[threadIdx.x + 7 * blockDim.x] = nc6_1x;
    partial_sum[threadIdx.x + 8 * blockDim.x] = nc6_1y;
    partial_sum[threadIdx.x + 9 * blockDim.x] = nc6_1z;
    partial_sum[threadIdx.x + 10 * blockDim.x] = nc6_2x;
    partial_sum[threadIdx.x + 11 * blockDim.x] = nc6_2y;
    partial_sum[threadIdx.x + 12 * blockDim.x] = nc6_2z;
    partial_sum[threadIdx.x + 13 * blockDim.x] = nc6_3x;
    partial_sum[threadIdx.x + 14 * blockDim.x] = nc6_3y;
    partial_sum[threadIdx.x + 15 * blockDim.x] = nc6_3z;
    partial_sum[threadIdx.x + 16 * blockDim.x] = nc6_4x;
    partial_sum[threadIdx.x + 17 * blockDim.x] = nc6_4y;
    partial_sum[threadIdx.x + 18 * blockDim.x] = nc6_4z;
    partial_sum[threadIdx.x + 19 * blockDim.x] = nc6_5x;
    partial_sum[threadIdx.x + 20 * blockDim.x] = nc6_5y;
    partial_sum[threadIdx.x + 21 * blockDim.x] = nc6_5z;
    partial_sum[threadIdx.x + 22 * blockDim.x] = cont6_0;
    partial_sum[threadIdx.x + 23 * blockDim.x] = cont6_1;
    partial_sum[threadIdx.x + 24 * blockDim.x] = cont6_2;
    partial_sum[threadIdx.x + 25 * blockDim.x] = cont6_3;
    partial_sum[threadIdx.x + 26 * blockDim.x] = cont6_4;
    partial_sum[threadIdx.x + 27 * blockDim.x] = cont6_5;
